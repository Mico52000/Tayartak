  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        {/* <p className='center'>From {this.props.SelectedFlightRet.From} to {this.props.SelectRetFlight.To} <br/>
        ...
        <Typography variant="p" gutterBottom>
          ...
          <br/>
          Price Diff: {"$"+(cabin==="economy"? this.props.SelectedFlightRet.PriceEconomy-this.props.retprice :
           cabin==="business"? this.props.SelectedFlightRet.PriceBusiness-this.props.retprice: this.props.SelectedFlightRet.PriceFirst-this.props.retprice)}
          <br/>
        </Typography>
        </React.Fragment>
        ) :""}
